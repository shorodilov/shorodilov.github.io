...
export const Button = ({ children, className, type = "button", variant = "primary", ...props }: ButtonProps) => (
    <button
        className={clsx(
            "type-button focus-visible:outline-focus-ring inline-flex shrink-0 cursor-pointer items-center justify-center border-0 transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed motion-reduce:transition-none",
