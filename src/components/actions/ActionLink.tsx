...
export const ActionLink = ({
  ...
  return (
    <a
      ...
      className={clsx(
        "inline-flex shrink-0 cursor-pointer items-center justify-center border-0 no-underline transition-colors duration-150 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring aria-disabled:cursor-not-allowed motion-reduce:transition-none",
